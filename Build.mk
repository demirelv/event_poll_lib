...
_CFLAGS    := -Wall -Wextra -Werror -pipe -g3 -O2 -fsigned-char -fno-strict-aliasing -fPIC -Werror=unused-result $(CFLAGS) $(EXTRA_CFLAGS)
...
${OUTDIR}/.$1:
	$(Q)$(MKDIR) $$@
${OUTDIR}/.$1/%.o: %.c
	$(Q) echo CC $$<; $(CC) $(_CFLAGS) $($1-cflags-y) $($1-incs) -c $$< -o $$@
...
${OUTDIR}/$1: ${OUTDIR}/.$1 $($1-objs)
	$(Q) echo CC $$@; $(CC) $($1-objs) -o $$@ ${LDFLAGS} $($1-ldflags-y) $($1-libps) $($1-library-y)
endef
